...
Target: Apprenticeship (Operations, Fwd Brands), Bangalore. Seeking to learn PO creation and Myntra system workflows and deliver daily tasks within TAT.
...
- Diagnosed Electron WebGL GPU memory leak on Windows (authored [Issue #8438](https://github.com/BasedHardware/omi/issues/8438), merged downstream in [PR #8902](https://github.com/BasedHardware/omi/pull/8902)); kept a solo build working across hardware, firmware, and backend to hold the prototype together.
...
**Operations:** Store inventory systems, POS workflows, daily floor operations, workflow coordination, task follow-through

**Software and Data:** Python (FastAPI, PyTorch, asyncio), TypeScript/JavaScript (Node.js, React, Vite), REST APIs, Git/GitHub, Vitest, structured data tables in ML experiment and test tracking

**Hardware:** 3D CAD (STL), Wearable Device Packaging, ESP32-S3 Firmware, Rapid Prototyping
...
- Built a compiled TypeScript CLI automating a 5-stage engineering harness with immutable JSONL state tracking and verification gates (lint, typecheck, Vitest).
